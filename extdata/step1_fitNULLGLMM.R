...
library(SAIGE, lib.loc="/net/hunt/zhowei/project/imbalancedCaseCtrlMixedModel/Rpackage_SPAGMMAT/installSAIGEFolder/0.35.5.2")
...
option_list <- list(
  ...
  make_option("--outputPrefix_varRatio", type="character", default=NULL,
    help="path and prefix to the output the variance ratio file [default=NULL]. if NULL, it will be the same as the outputPrefix"),
