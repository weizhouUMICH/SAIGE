...
setMissing_Matrix_vcf <- function(isDropMissing, noMissingDosages) {
    invisible(.Call('_SAIGE_setMissing_Matrix_vcf', PACKAGE = 'SAIGE', isDropMissing, noMissingDosages))
}
...
setMissing_bgen <- function(isDropMissing, noMissingDosages) {
    invisible(.Call('_SAIGE_setMissing_bgen', PACKAGE = 'SAIGE', isDropMissing, noMissingDosages))
}
...
setMissing_vcf <- function(isDropMissing, noMissingDosages) {
    invisible(.Call('_SAIGE_setMissing_vcf', PACKAGE = 'SAIGE', isDropMissing, noMissingDosages))
}
